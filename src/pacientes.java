...
public class pacientes {
        ...
        //^Crea el HashMap de pacientes.

        static String nombreArchivo = "db//pacientes.csv";
    ...
    public static void load(){
        ...
        public static void agregar(){
            ...
            System.out.println("Escriba a continuación el nombre del paciente:");

            Scanner nom = new Scanner(System.in);
            String nombre = nom.nextLine();
            int pSize = pacientes.size() + 1;
            String pNew = String.valueOf(pSize);
            pacientes.put(pNew,nombre);

            save();
            System.out.println("Se agregó el paciente exitosamente. Volviendo al menú principal.");
    ...
    public static void save(){
        try {
            ...
            for (Map.Entry<String, String> set: pacientes.entrySet()){
